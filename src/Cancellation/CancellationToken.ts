...
export default class CancellationToken {
    ...
    public constructor(source: Nullable<CancellationTokenSource>);
    public constructor(value?: Nullable<CancellationTokenSource> | boolean) {
        if (value == null) {
            this.source = null;
    ...
    public get canBeCanceled(): boolean {
        return !!this.source && this.source.canBeCanceled;
    }

    public get isCancellationRequested(): boolean {
        return !!this.source && this.source.isCancellationRequested;
    }
